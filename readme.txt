...
and those links will only show up when anyone having administrator rights is 
logged on (userlever_8 or above). 

== Installation ==

1. Upload `bp_linksplus.php` to the `/wp-content/plugins/` directory.
1. Activate the plugin through the 'Plugins' menu in WordPress.
1. Under the 'Manage->Link Categories' administration page, create at least one link category that begins with the word 'Admin' or 'admin'. The name can be followed by any other text.
